...
def date_if(prefer_sit,driver):
    ...
    if times_roll and len(times_roll) > 0:
        ...
        if all(time in full_day_times for time in get_time_range(full_day_times,"20:00","21:00")):
            day_type = 3
...
def choose_it(driver, sit_avilable, idx, reading_room, day_type, max_attempts=500):
    ...
    bool: 预约是否成功
    """
    dir_time = {3: [['20:00', '21:00'], ['20:00', '21:00']], 2: [['14:00', '18:00'], ['18:00', '22:00']]}
        ...
        try:
            ...
            if times_roll and len(times_roll) > 0:
                ...
                if all(time in full_day_times for time in
                       get_time_range(full_day_times, "20:00", "21:00")):
...
def main():
    ...
    sit_avilable, day_type = None, None
    users = {"自定义": [account_password4, "三楼理科书库", "69"]}
    user = "自定义"
